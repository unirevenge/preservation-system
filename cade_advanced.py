...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('cade_advanced.log'),
...
class KnowledgeBasePlugin(CadePlugin):
    ...
    def add_knowledge(self, key: str, content: Any, metadata: Optional[Dict] = None) -> str:
...
def main():
    ...
    if kb:
        # Add some knowledge
        kb.add_knowledge("python.tips", "Use list comprehensions for better readability")
        kb.add_knowledge("python.functions", "Functions should do one thing and do it well")
